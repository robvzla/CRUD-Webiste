...
<?php include('template/header.php'); ?>
    ...
    <div class="wrapper">
        <p class="form-title">(1) Match Found.</p>
        <p class="form-title">Update kid's daily detail.</p>

        <!--Creating the form and linking it to php response page-->
        <form action="includes/updatedetails.inc.php" method="POST" class="signInForm">
            ...
            ?>
            <p class="form-title">Update Details</p>
                ...
                <input type="number" name="temperature" min="10.0" max="100.0" step=".1" placeholder="e.g. 33.5" value="<?php echo($_SESSION["temperaturedetail"]); ?>" class="form-input">

                <!--Field for breakfast-->
                <label for="breakfast" class="form-label">Breakfast:</label>
                <input type="text" name="breakfast" placeholder="e.g. Omelet" value="<?php echo($_SESSION["breakfastdetail"]); ?>" class="form-input">

                <!--Field for lunch-->
                <label for="lunch" class="form-label">Lunch:</label>
                <input type="text" name="lunch" placeholder="e.g. Pasta" value="<?php echo($_SESSION["lunchdetail"]); ?>" class="form-input">

                <!--Field for lunch-->
                <label for="activities" class="form-label">Activities:</label>
                <input type="text" name="activities" placeholder="e.g. Drawing, ..." value="<?php echo($_SESSION["activitiesdetail"]); ?>" class="form-input">
